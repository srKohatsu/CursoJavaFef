 ...
 * @author johat
 */
@WebServlet(name = "FornecedorCarregar", urlPatterns = {"/FornecedorCarregar"})
public class FornecedorCarregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            Fornecedor oFor = (Fornecedor) dao.carregar(idFornecedor);
            
            Gson ogson = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
            String jSon = ogson.toJson(oFor);
