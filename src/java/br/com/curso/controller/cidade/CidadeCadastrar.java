    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
           ...
           if (dao.cadastrar(oCidade)){
               ...
               mensagem = "Problemas ao cadastar Cidade.Verefique os dados informados e tente novamente!";
           }
           request.setAttribute("mensagem", mensagem);
           response.sendRedirect("CidadeListar");
        } catch  (Exception ex){
            System.out.println("Problemas ao Servlet ao cadastrar Cidade! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
    }
