    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if (dao.cadastrar(oEstado)){
                mensagem = "Estado cadastardo com sucesso!";
            }else {
                mensagem = "Problema ao cadastrar Estado.Verifique os dados informados e tente novamente!";
            }
            request.setAttribute("mensagem", mensagem);
            response.sendRedirect("EstadoListar");
        
        } catch (Exception ex) {
            System.out.println("Problemas no Servle ao cadastrar Estado! Erro:"+ ex.getMessage());
        }
    }
